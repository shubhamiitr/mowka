...
import { Goal, Cpu, Zap, Lock, Shield, Terminal, ShieldCheck } from 'lucide-react';
import { HOME_PAGE } from '../../constants/content';

const REASON_ICONS = [Goal, Cpu, Zap, Lock, Shield, Terminal];
