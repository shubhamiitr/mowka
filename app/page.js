    ...
    "@graph": [
        ...
        },
        {
            ...
            "applicationContact": {
                ...
                "name": "Mowka (Official Hiring Partner)",
                "email": "shubham@mowka.in"
            },
            "directApply": true,
            "url": "https://forms.gle/HbDkXKP7TSJ4keJ26"
        },
        {
            "@type": "JobPosting",
            "@id": "https://mowka.in/#job-product-support",
            "title": "Product Support Engineer (Forward Deployed)",
            "description": "Join RinggAI as a customer-facing technical engineer. Requires high ownership, strong communication skills, and the ability to solve complex technical problems in fast-paced customer environments.",
            "datePosted": "2025-12-31",
            "validThrough": "2026-03-31",
            "employmentType": "FULL_TIME",
            "baseSalary": {
