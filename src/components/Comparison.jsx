                ...
                <div className="w-full min-h-full flex flex-col justify-center pt-20 pb-2 md:py-12 px-4 md:px-12">
                    <div className="max-w-7xl mx-auto w-full">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border border-gray-200 rounded-2xl md:rounded-[32px] overflow-hidden shadow-2xl isolate max-w-6xl mx-auto w-full">
                            ...
                            {/* Typical Agency */}
                            <div className="bg-gray-50/80 backdrop-blur-sm p-4 md:p-14 border-b md:border-b-0 md:border-r border-gray-200 flex flex-col justify-center group hover:bg-gray-100/50 transition-colors">
                                <h3 className="text-xl md:text-4xl font-medium text-gray-400 mb-1 md:mb-2 font-serif group-hover:text-gray-500 transition-colors">Standard Agency</h3>
                                <p className="text-[9px] md:text-[10px] text-gray-400 mb-3 md:mb-8 uppercase tracking-[0.2em] font-bold">The "Transactional" Model</p>
                            ...
                            {/* Mowka */}
                            <div className="bg-mowka-navy p-4 md:p-14 relative overflow-hidden text-white flex flex-col justify-center group z-10">
                                <h3 className="text-xl md:text-4xl font-medium text-white mb-1 md:mb-2 font-serif relative z-10">Mowka</h3>
                                <p className="text-[9px] md:text-[10px] text-mowka-teal mb-3 md:mb-8 uppercase tracking-[0.2em] font-bold relative z-10">The "Extension" Model</p>

                                <ul className="space-y-2 md:space-y-8 relative z-10">
