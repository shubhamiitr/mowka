    ...
    >
      ...
      <div className="max-w-7xl w-full px-4 md:px-6 relative z-10 flex flex-col justify-center h-full">
        <div className="flex flex-col items-center text-center max-w-5xl mx-auto w-full">
          ...
          <h1 className="text-3xl sm:text-6xl md:text-7xl lg:text-8xl font-medium tracking-tighter md:tracking-tight text-mowka-navy mt-4 md:mt-8 mb-4 md:mb-6 leading-[1.1] md:leading-[1.05] font-serif animate-fade-in-up delay-75">
          ...
          <div className="max-w-3xl mx-auto mb-6 md:mb-12 animate-fade-in-up delay-150 opacity-0" style={{ animationFillMode: 'forwards' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-5 mb-6 md:mb-16 w-full sm:w-auto justify-center animate-fade-in-up delay-200 opacity-0" style={{ animationFillMode: 'forwards' }}>
            <a
              href="#contact"
