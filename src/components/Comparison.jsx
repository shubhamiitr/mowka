                ...
                <div className="w-full flex flex-col justify-center px-4 md:px-12">
                    <div className="max-w-7xl mx-auto w-full">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 max-w-6xl mx-auto w-full">
                            ...
                            <div className="bg-white p-4 md:p-10 border border-mowka-border-light rounded-2xl md:rounded-3xl flex flex-col shadow-sm">
                            ...
                            {/* Mowka */}
                            <div className="bg-white p-4 md:p-10 border-2 border-mowka-teal-vibrant rounded-2xl md:rounded-3xl flex flex-col shadow-lg relative overflow-hidden">
